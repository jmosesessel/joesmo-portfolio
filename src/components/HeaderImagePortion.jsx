...
const HeaderImagePortion = () => {
  return (
    <>
        <div className='md:absolute md:right-0 text-p-white flex flex-col items-center mb-[2.5rem] w-[10.875rem] md:w-[20.125rem] h-[23.9375rem] bg-gradient-to-t from-p-black '>
