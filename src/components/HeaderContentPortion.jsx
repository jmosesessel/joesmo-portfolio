  ...
  return (
    <>
        <div className=' flex flex-col justify-center md:justify-start items-center md:items-start md:text-left text-p-white md:mt-20'>
          ...
          <p className='md:w-[27rem] md:text-[1.125rem] text-center md:text-left text-p-grey mb-6 '>Based in the Ghana, I’m a front-end developer passionate about building accessible web apps that users love.</p>
